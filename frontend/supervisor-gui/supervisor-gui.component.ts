...
import { SupervisorGuiService } from './supervisor-gui.service';

@Component({
    selector : 'supervisor-gui',
    templateUrl : './supervisor-gui.html',
    styleUrls : ['./supervisor-gui.css'],
    providers : [SupervisorGuiService]
})
export class SupervisorGuiComponent implements OnInit, OnDestroy {
    error: Object;
    ...
    constructor(private api: SupervisorGuiService) {}
